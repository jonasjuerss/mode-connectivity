...
__all__ = ['PreResNet110', 'PreResNet164', 'PreResNet20', 'PreResNet20MNIST']
...
class PreResNetCurve(nn.Module):
    ...
    def __init__(self, num_classes, fix_points, depth=110, avg_pool=8):
        ...
        self.conv1 = curves.Conv2d(1, 64, kernel_size=3, padding=1,
        ...
        self.bn = curves.BatchNorm2d(256 * block.expansion, fix_points=fix_points)
        self.relu = nn.ReLU(inplace=True)
        self.avgpool = nn.AvgPool2d(avg_pool)
